package hr.fer.zemris.irg.lab1.zad2.src.common;
...
public class GLDisplay {
    private static final int DEFAULT_WIDTH = 800;  //poèetna širina prozora
    private static final int DEFAULT_HEIGHT = 600; // poèetna visina prozora
    ...
    public static GLDisplay createGLDisplay( String title, GLCapabilities caps ) {
        boolean fullscreen = false;  //true - fullscreen
